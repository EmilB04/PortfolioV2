...
const en = {
    ...
    knowledge: {
        ...
        skills: {
            vue: 'Progressive JS framework for building UIs',
            react: 'Component-based UI library by Meta',
            reactNative: 'Build native mobile apps using React',
            quasar: 'Full-stack Vue framework with rich component library',
            html: 'Standard markup language for web pages',
            css: 'Stylesheet language for visual presentation',
            javascript: 'Dynamic scripting language of the web',
            typescript: 'JavaScript with static type safety',
            sass: 'CSS preprocessor with variables and nesting',
            nodejs: 'JavaScript runtime for server-side development',
            dotnet: 'Microsoft cross-platform application framework',
            python: 'Versatile language for scripting and backends',
            java: 'Object-oriented language for enterprise applications',
            csharp: 'Microsoft language for .NET applications',
            mysql: 'Open-source relational database system',
            supabase: 'Postgres backend with auth, storage and edge functions',
            auth0: 'Managed authentication and authorization platform',
            cShell: 'Systems programming and Unix shell scripting',
            expo: 'Toolchain for building React Native apps',
            git: 'Distributed version control system',
            github: 'Code hosting and collaboration platform',
            azure: 'Microsoft cloud computing platform',
            cloudflare: 'CDN, DNS and edge compute platform',
            render: 'Cloud hosting for web services and databases',
            cloudinary: 'Media storage with on-the-fly image optimization',
...
const no: TranslationSchema = {
    ...
    knowledge: {
        ...
        skills: {
            vue: 'Progressivt JS-rammeverk for å bygge brukergrensesnitt',
            react: 'Komponentbasert UI-bibliotek fra Meta',
            reactNative: 'Bygg native mobilapper med React',
            quasar: 'Full-stack Vue-rammeverk med rikt komponentbibliotek',
            html: 'Standard markeringsspråk for nettsider',
            css: 'Stilarkspråk for visuell presentasjon',
            javascript: 'Dynamisk skriptspråk for nettet',
            typescript: 'JavaScript med statisk typesikkerhet',
            sass: 'CSS-preprosessor med variabler og nesting',
            nodejs: 'JavaScript-runtime for serverutvikling',
            dotnet: 'Microsofts plattformuavhengige applikasjonsrammeverk',
            python: 'Allsidig språk for skripting og backend',
            java: 'Objektorientert språk for bedriftsapplikasjoner',
            csharp: 'Microsofts språk for .NET-applikasjoner',
            mysql: 'Åpen kildekode relasjonsdatabase',
            supabase: 'Postgres-backend med auth, lagring og edge-funksjoner',
            auth0: 'Administrert plattform for autentisering og autorisasjon',
            cShell: 'Systemprogrammering og Unix shell-scripting',
            expo: 'Verktøykjede for å bygge React Native-apper',
            git: 'Distribuert versjonskontrollsystem',
            github: 'Kodehosting og samarbeidsplattform',
            azure: 'Microsofts skytjenesteplattform',
            cloudflare: 'CDN, DNS og edge-databehandlingsplattform',
            render: 'Skyhosting for webtjenester og databaser',
            cloudinary: 'Medielagring med optimalisering av bilder på sparket',
            figma: 'Samarbeidsverktøy for UI/UX-design',
            trello: 'Visuell prosjektledelse med tavler',
        },
    },
    certifications: {
...
const es: TranslationSchema = {
    ...
    knowledge: {
        ...
        skills: {
            vue: 'Framework JS progresivo para construir interfaces',
            react: 'Biblioteca de UI basada en componentes de Meta',
            reactNative: 'Crea apps móviles nativas con React',
            quasar: 'Framework full-stack de Vue con una amplia biblioteca de componentes',
            html: 'Lenguaje de marcado estándar para páginas web',
            css: 'Lenguaje de hojas de estilo para la presentación visual',
            javascript: 'Lenguaje de scripting dinámico de la web',
            typescript: 'JavaScript con tipado estático',
            sass: 'Preprocesador CSS con variables y anidamiento',
            nodejs: 'Entorno de ejecución de JavaScript para el servidor',
            dotnet: 'Framework multiplataforma de Microsoft',
            python: 'Lenguaje versátil para scripting y backends',
            java: 'Lenguaje orientado a objetos para aplicaciones empresariales',
            csharp: 'Lenguaje de Microsoft para aplicaciones .NET',
            mysql: 'Sistema de base de datos relacional de código abierto',
            supabase: 'Backend Postgres con auth, almacenamiento y edge functions',
            auth0: 'Plataforma gestionada de autenticación y autorización',
            cShell: 'Programación de sistemas y scripting de shell Unix',
            expo: 'Conjunto de herramientas para crear apps React Native',
            git: 'Sistema de control de versiones distribuido',
            github: 'Plataforma de alojamiento de código y colaboración',
            azure: 'Plataforma de computación en la nube de Microsoft',
            cloudflare: 'Plataforma de CDN, DNS y computación en el edge',
            render: 'Alojamiento en la nube para servicios web y bases de datos',
            cloudinary: 'Almacenamiento de medios con optimización de imágenes al vuelo',
            figma: 'Herramienta colaborativa de diseño UI/UX',
            trello: 'Gestión visual de proyectos con tableros',
        },
    },
    certifications: {
...
const de: TranslationSchema = {
    ...
    knowledge: {
        ...
        skills: {
            vue: 'Progressives JS-Framework zum Erstellen von Benutzeroberflächen',
            react: 'Komponentenbasierte UI-Bibliothek von Meta',
            reactNative: 'Native mobile Apps mit React entwickeln',
            quasar: 'Full-Stack-Vue-Framework mit umfangreicher Komponentenbibliothek',
            html: 'Standard-Auszeichnungssprache für Webseiten',
            css: 'Stylesheet-Sprache für die visuelle Darstellung',
            javascript: 'Dynamische Skriptsprache des Webs',
            typescript: 'JavaScript mit statischer Typsicherheit',
            sass: 'CSS-Präprozessor mit Variablen und Verschachtelung',
            nodejs: 'JavaScript-Laufzeitumgebung für serverseitige Entwicklung',
            dotnet: 'Plattformübergreifendes Anwendungs-Framework von Microsoft',
            python: 'Vielseitige Sprache für Skripting und Backends',
            java: 'Objektorientierte Sprache für Unternehmensanwendungen',
            csharp: 'Microsoft-Sprache für .NET-Anwendungen',
            mysql: 'Open-Source-relationale Datenbank',
            supabase: 'Postgres-Backend mit Auth, Storage und Edge-Funktionen',
            auth0: 'Verwaltete Plattform für Authentifizierung und Autorisierung',
            cShell: 'Systemprogrammierung und Unix-Shell-Scripting',
            expo: 'Toolchain zum Erstellen von React-Native-Apps',
            git: 'Verteiltes Versionskontrollsystem',
            github: 'Plattform für Code-Hosting und Zusammenarbeit',
            azure: 'Microsofts Cloud-Computing-Plattform',
            cloudflare: 'CDN-, DNS- und Edge-Computing-Plattform',
            render: 'Cloud-Hosting für Webdienste und Datenbanken',
            cloudinary: 'Medienspeicher mit On-the-fly-Bildoptimierung',
...
const fr: TranslationSchema = {
    ...
    knowledge: {
        ...
        skills: {
            vue: 'Framework JS progressif pour créer des interfaces',
            react: 'Bibliothèque UI basée sur les composants, par Meta',
            reactNative: 'Créez des applications mobiles natives avec React',
            quasar: 'Framework full-stack Vue avec une riche bibliothèque de composants',
            html: 'Langage de balisage standard pour les pages web',
            css: 'Langage de feuilles de style pour la présentation visuelle',
            javascript: 'Langage de script dynamique du web',
            typescript: 'JavaScript avec typage statique',
            sass: 'Préprocesseur CSS avec variables et imbrication',
            nodejs: "Environnement d'exécution JavaScript côté serveur",
            dotnet: 'Framework applicatif multiplateforme de Microsoft',
            python: 'Langage polyvalent pour le scripting et les backends',
            java: "Langage orienté objet pour les applications d'entreprise",
            csharp: 'Langage Microsoft pour les applications .NET',
            mysql: 'Système de base de données relationnelle open source',
            supabase: 'Backend Postgres avec auth, stockage et edge functions',
            auth0: "Plateforme gérée d'authentification et d'autorisation",
            cShell: 'Programmation système et scripting shell Unix',
            expo: "Chaîne d'outils pour créer des applications React Native",
            git: 'Système de contrôle de version distribué',
            github: "Plateforme d'hébergement de code et de collaboration",
            azure: 'Plateforme cloud computing de Microsoft',
            cloudflare: 'Plateforme CDN, DNS et edge computing',
            render: 'Hébergement cloud pour services web et bases de données',
            cloudinary: "Stockage de médias avec optimisation d'images à la volée",
            figma: 'Outil collaboratif de conception UI/UX',
            trello: 'Gestion de projet visuelle avec des tableaux',
        },
    },
    certifications: {
